...
[`docs/spec.md`](https://github.com/stowage-js/stowage/blob/main/docs/spec.md#6-stowageadapter-fs), which is the contract: a caller may rely on what that document
